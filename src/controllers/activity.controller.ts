...
export class ActivityController {
  ...
  static async getMoods(req: AuthenticatedRequest, res: Response) {
    ...
    res.json(moods.map((m: any) => ({ id: m.id, createdAt: m.createdAt, ...(m.data as any) })));
  }
  ...
  static async getJournals(req: AuthenticatedRequest, res: Response) {
    ...
    res.json(journals.map((j: any) => ({ id: j.id, createdAt: j.createdAt, updatedAt: j.updatedAt, ...(j.data as any) })));
  }
  ...
  static async getStressHistory(req: AuthenticatedRequest, res: Response) {
    ...
    res.json(history.map((h: any) => ({ ...(h.data as any), date: h.date })));
  }
  ...
  static async getMindfulness(req: AuthenticatedRequest, res: Response) {
    ...
    res.json(mindfulness.map((m: any) => ({ id: m.id, dateISO: m.dateISO, ...(m.data as any) })));
  }
  ...
  static async getSleep(req: AuthenticatedRequest, res: Response) {
    ...
    res.json(sleep.map((s: any) => ({ id: s.id, createdAtISO: s.createdAtISO, ...(s.data as any) })));
  }
